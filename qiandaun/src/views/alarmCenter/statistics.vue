  ...
  <div class="content-box">
    <el-form inline :model="form" class="demo-form-inline">
      ...
      <el-form-item label="参数名称">
        <el-select v-model="form.name" size="mini" placeholder="请选择">
          <el-option
    ...
    <el-form inline :model="form1" class="demo-form-inline">
      <el-form-item label="事件名称">
        <el-input v-model="form1.eventName" prefix-icon="el-icon-search" size="mini" placeholder="搜索事件名称" />
      </el-form-item>
      <el-form-item label="所属设备">
        <el-select v-model="form1.tagName" size="mini" placeholder="请选择所属设备">
          <el-option
...
<script>
import { getList } from '@/api/alarmCenter/flowPath'
import { getDeviceByType } from '@/api/alarmCenter/information'
export default {
  data() {
    return {
      form: {

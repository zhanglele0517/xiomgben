  ...
  <div class="content-box">
    <el-row type="flex" justify="space-between">
      <el-form inline :model="form" class="demo-form-inline">
        ...
        <el-input v-model="input"  size="mini" placeholder="请输入系统类型"></el-input>
        </el-form-item>
        <el-form-item label="系统名称">
         <el-input v-model="input1"  size="mini" placeholder="请输入系统名称"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <dv-border-box-10>
        <div style="padding: 20px">
          ...
          >
            ...
            <el-table-column prop="shebei" align="center" label="系统类型" />
            <el-table-column prop="shijian" align="center" label="系统名称" />
            <el-table-column
              prop="yuanyin"
              align="center"
              label="创建时间"
